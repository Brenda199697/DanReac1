  ...
  <LinkContainer to="/"><Navbar.Brand className="swirl-in-fwd"><img className="navbar-brand" src={logo} width="150px" alt="logo" /></Navbar.Brand></LinkContainer>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="me-auto">
        ...
        <LinkContainer onClick={() => setExpanded(false)} to="/category/zapatos"><NavDropdown.Item>zaatos</NavDropdown.Item></LinkContainer>
        <LinkContainer onClick={() => setExpanded(false)} to="/category/verano"><NavDropdown.Item>verano</NavDropdown.Item></LinkContainer>
        <LinkContainer onClick={() => setExpanded(false)} to="/category/invierno"><NavDropdown.Item>invierno</NavDropdown.Item></LinkContainer>
          <NavDropdown.Divider />
          <LinkContainer onClick={() => setExpanded(false)} to="/category/sandalias"><NavDropdown.Item>sandalias</NavDropdown.Item></LinkContainer>
        </NavDropdown>
